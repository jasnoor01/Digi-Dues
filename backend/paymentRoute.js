                ...
                var post_req = https.request(options, function (post_res) {
                    ...
                    post_res.on('end', function () {
                        ...
                        if (result.STATUS === 'TXN_SUCCESS') {
                            //store in db
                            db.collection('payments').doc('1goOrZhKMl5hJ9VW9ts9').update({ paymentHistory: firebase.firestore.FieldValue.arrayUnion(result) })
...
router.post('/payment', (req, res) => {
    ...
    const { amount, email ,cId } = req.body;
    ...
    params['MID'] = process.env.PAYTM_MID,
        ...
        params['CALLBACK_URL'] = 'http://localhost:1000/api/callback',
        params['EMAIL'] = email,
